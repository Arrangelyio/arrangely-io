-- Create event registrations without user_id constraint by setting user_id to null temporarily
-- and focus on the lottery demo data
...
BEGIN
    ...
    -- Get an admin user ID to use as a placeholder
    ...
    FOR i IN 1..100 LOOP
        -- Generate a unique dummy user ID for each registration
        ...
        INSERT INTO public.event_registrations (
            ...
            event_uuid,
            admin_user_id, -- Use admin user as placeholder
