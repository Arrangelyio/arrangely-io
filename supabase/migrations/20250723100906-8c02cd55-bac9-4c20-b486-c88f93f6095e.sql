...
INSERT INTO public.subscription_plans (name, price, currency, interval_type, interval_count, features, is_active) VALUES
('Basic Monthly', 99000, 'IDR', 'month', 1, '{"features": ["Unlimited song creation", "Basic chord suggestions", "PDF export", "Basic support"]}', true),
('Pro Monthly', 199000, 'IDR', 'month', 1, '{"features": ["All Basic features", "Advanced AI analysis", "Team collaboration", "Priority support", "Custom themes"]}', true),
('Basic Yearly', 999000, 'IDR', 'year', 1, '{"features": ["Unlimited song creation", "Basic chord suggestions", "PDF export", "Basic support"], "discount": "2 months free"}', true),
('Pro Yearly', 1999000, 'IDR', 'year', 1, '{"features": ["All Basic features", "Advanced AI analysis", "Team collaboration", "Priority support", "Custom themes"], "discount": "2 months free"}', true);

-- Insert sample discount codes
INSERT INTO public.discount_codes (code, discount_type, discount_value, max_uses, valid_from, valid_until, is_active) VALUES
('WELCOME20', 'percentage', 20, 100, now(), now() + INTERVAL '3 months', true),
('EARLY50', 'percentage', 50, 50, now(), now() + INTERVAL '1 month', true),
('STUDENT30', 'percentage', 30, NULL, now(), now() + INTERVAL '1 year', true);