...
const ORIGININAL_URL = 'https://arrangely.io';
...
export default {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === "/robots.txt") {
      return fetch(`${SUPABASE_URL}/functions/v1/seo-generator`, {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({ type: "robots" })
      });
    }
    ...
    if (url.pathname.match(/\.(js|css|jpg|jpeg|png|gif|svg|ico|woff|woff2|ttf|eot|json)$/i)) {
